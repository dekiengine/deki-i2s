...
Notable changes to `deki-i2s`. Engine and editor changes are in the
...
### Changed
- **Moved into the `DekiI2s` namespace.** Every component was declared at global
  ...
  Code naming these types needs the namespace: `using namespace DekiI2s;` or a
  qualified name.
